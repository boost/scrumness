...
google.load('visualization', '1.1', {packages: ['line', 'corechart']});
google.setOnLoadCallback(drawSprintVelocityChart);

function drawSprintVelocityChart() {
  var graph = $('#sprint-velocity-graph');
  var graph_data = JSON.parse($('#sprint-velocity-graph').attr('data-points')); 
  var chartDiv = document.getElementById('sprint-velocity-graph-div');
  var data = new google.visualization.DataTable();
